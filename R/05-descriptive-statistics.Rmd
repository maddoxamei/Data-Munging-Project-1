...
```{r schooldistribution, fig.cap="School Distribution", echo=FALSE, warning=F, messages=F}
school.distribution()
```

## Earnings Variable

```{r earningspercentiles, fig.cap="Percentiles of Earnings", echo=FALSE, warning=F, messages=F}
earnings.percentiles()
```

```{r earningssd, fig.cap="Standard Deviation of Earnigns", echo=FALSE, warning=F, messages=F}
earnings.sd()
```

## Cost Variable

```{r tutionstream, fig.cap="Tuition Over the Years", echo=FALSE, warning=F, messages=F}
tuition.stream()
```

```{r coststream, fig.cap="Cost Over the Years", echo=FALSE, warning=F, messages=F}
cost.stream()
```
...
```{r costtoearninst, fig.cap="Institution Cost to Earnings", echo=FALSE, warning=F, messages=F}
cost.to.earnings(csb.data.unitid, "{point.instnm}", "Averaged across all years")
```

```{r costtoearnyear, fig.cap="Yearly Cost to Earnings", echo=FALSE, warning=F, messages=F}
